...
var UsuarioEditComponent = /** @class */ (function () {
    function UsuarioEditComponent(usuarioService, 
    ...
    UsuarioEditComponent.prototype.createFormGroupWithBuilder = function (formBuilder) {
        return formBuilder.group({
            ...
            confirmasenha: new _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormControl"]('', _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].required),
        }, {
            validator: this.MustMatch('senha', 'confirmasenha')
        });
    };
    UsuarioEditComponent.prototype.MustMatch = function (controlName, matchingControlName) {
    ...
    UsuarioEditComponent.prototype.cadastrarUsuario = function () {
        var formData = new FormData();
        formData.append('value', JSON.stringify(this.usuario));
        formData.append('file', this.fileData);
        this.usuarioService.registerUser(formData).subscribe(function (data) {
            console.log(data);
        });
    };
...
var CardDoacaoComponent = /** @class */ (function () {
    ...
    CardDoacaoComponent.prototype.sanitizeImage = function (id, file) {
        console.log("url(" + src_app_global__WEBPACK_IMPORTED_MODULE_3__["Global"].baseUrl + 'arquivo/doacao/' + id + '/' + file + ")");
...
var CardEncontradoComponent = /** @class */ (function () {
    ...
    CardEncontradoComponent.prototype.sanitizeImage = function (id, file) {
        console.log("url(" + src_app_global__WEBPACK_IMPORTED_MODULE_3__["Global"].baseUrl + 'arquivo/encontrado/' + id + '/' + file + ")");
...
var CardPerdidoComponent = /** @class */ (function () {
    ...
    CardPerdidoComponent.prototype.sanitizeImage = function (id, file) {
        console.log("url(" + src_app_global__WEBPACK_IMPORTED_MODULE_3__["Global"].baseUrl + 'arquivo/perdido/' + id + '/' + file + ")");
...
var HeaderComponent = /** @class */ (function () {
    ...
    HeaderComponent.prototype.login = function () {
        var _this = this;
        this.autenticacaoService.login(this.formLoginEmail, this.formLoginSenha).subscribe(function (response) {
...
var AutenticacaoService = /** @class */ (function () {
    ...
    AutenticacaoService.prototype.login = function (username, password) {
        ...
        return this.http.post(_global__WEBPACK_IMPORTED_MODULE_4__["Global"].baseUrl + "usuario/autenticar", formData, { observe: 'response' })
